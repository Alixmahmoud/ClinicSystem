namespace Clinic.Client.Domain.Queue;

/// <summary>
/// Workstation-local patient-flow/queue entry. Frozen: Patient Flow State is a distinct
/// concept from Appointment Status and from Visit State. The queue position is derived
/// from entry order, not stored as mutable ordering state.
/// </summary>
